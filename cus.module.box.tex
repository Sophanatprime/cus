...
%     \cus@update@multi@width\linewidth
%     \hsize\linewidth#2}}
...
%     \cus@update@multi@height\@colroom
%     \dimen@\@colroom#2}}
% \expandafter\foo\prepare@multicols!!
...
\cs_new_protected:Npn \__cus_multicolumns_process_framedoptions: 
  { 
    \__cus_filter_geometry_options:NNN 
      \cus@multicol@framed@options 
      \cus@multicol@framedgeometry@options 
      \cus@multicol@framed@options 
    \exp_args:No \cus@update@multi@framedgeometry \cus@multicol@framedgeometry@options 
  }
\keys_define:nn { cus/multicolumns }
  {
    framed / fbox .code:n = 
      {
        \cs_set_protected:Npn \cus@update@multi@height ##1
          { \advance##1-\dimexpr2\fboxrule+2\fboxsep\relax }
        ...
        \cs_set_protected:Npn \cus@update@multi@framedgeometry ##1 
          { \keyval_parse:nnn \scan_stop: \__cus_set_fbox_geometry:nn {##1} }
      }
  }
