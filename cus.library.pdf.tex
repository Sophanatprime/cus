...
\CusIfPdfmana { } { \c__cus_pdf_patch_tl \tex_endinput:D }
    ...
    \cs_new:Npn \__cus_pdf_pax_run_lt_script:
      {
        lualatex~ "\string\def\string\x{
          \exp_not:N \csname quote@name\endcsname{ \c_sys_jobname_str _pax_script.lua }
        }\string\directlua{dofile(\string\x)}\noexpand\stop"
      }
  }
  {
    \cs_new:Npn \__cus_pdf_pax_run_lt_script:
      { lualatex~ ' \string\directlua { \__cus_pdf_pax_run_script: } \noexpand\stop ' }
  }
