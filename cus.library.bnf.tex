...
\tl_new:N \l__cus_bnf_grometry_tl
...
\keys_define:nn { cus/texbnf }
  {
    ...
    indent .code:n = \tl_put_right:Nn \l__cus_bnf_grometry_tl { \setlength\listparindent{#1} } ,
    itemsep .code:n = \tl_put_right:Nn \l__cus_bnf_grometry_tl { \setlength\itemsep{#1} } ,
    parsep .code:n = \tl_put_right:Nn \l__cus_bnf_grometry_tl { \setlength\parsep{#1} } ,
  }
...
\cs_new_protected_nopar:Npn \BNFN #1
  { 
...
\NewDocumentCommand \BNFT { v } 
  { \cus_bnf_terminal_start: \tl_to_str:n {#1} \cus_bnf_terminal_stop: }
