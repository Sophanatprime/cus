...
\ekeysdeclarecmd \spreadtext { s m }
  {
    ...
    \tex_setbox:D \l__cus_tmpa_box 
      \elkernel_hbox:w to \elkernel_dim_expr:w #2 \scan_stop:
  }
\cs_new:Npn \__cus_spreadtext_auxi:
  {
    \__cus_spreadtext_set_skip:
    \c_group_begin_token
...
\bool_case:nF 
  {
    \sys_if_engine_uptex_p:
      {
        \cs_new_protected:Npn \__cus_spreadtext_set_skip:
          {
            \skip_set:Nn \spaceskip { 0pt plus 1fil }
            \skip_set:Nn \xspaceskip { 0pt plus 1fil }
            \skip_set:Nn \kanjiskip { 0pt plus 1fil }
            \skip_set:Nn \xkanjiskip { 0pt plus 1fil }
          }
      }
        ...
        \cs_new_protected:Npn \__cus_spreadtext_set_skip:
          {
            \skip_set:Nn \spaceskip { 0pt plus 1fil }
            \skip_set:Nn \xspaceskip { 0pt plus 1fil }
            \ltjsetparameter { kanjiskip=0pt plus 1fil, xkanjiskip=0pt plus 1fil }
          }
      }
    \sys_if_engine_xetex_p:
      {
        \cs_new_protected:Npn \__cus_spreadtext_set_skip:
          {
            \def\CJKglue{\hskip 0pt plus 1fil\relax}
            \def\CJKecglue{\hskip 0pt plus 1fil\relax}
            \skip_set:Nn \spaceskip { 0pt plus 1fil }
            \skip_set:Nn \xspaceskip { 0pt plus 1fil }
          }
      }
