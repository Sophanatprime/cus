...
\box_new:N \l__cus_box_internal_box
\cs_new_protected:Npn \__cus_box_frame:nnn #1#2#3
  {
    \group_begin:
      \hbox_set:Nn \l__cus_box_internal_box {#3}
      \hbox:n
        {
          \__cus_kern:n { #1 + #2 } % l sep 
          \box_use:N \l__cus_box_internal_box
          \__cus_kern:n { - \box_wd:N \l__cus_box_internal_box - #2 - #1 } % l 
          \box_move_down:nn { \box_dp:N \l__cus_box_internal_box + #2 + #1 }
            {
              \vbox:n
                {
                  ...
                  \hbox:n
                    {
                      ...
                      \__cus_kern:n { #2 * 2 + \box_wd:N \l__cus_box_internal_box }
                      \vbox:n
                        {
                          \__cus_kern:n 
                            {
                                  #2 * 2
                              + \box_dp:N \l__cus_box_internal_box
                              + \box_ht:N \l__cus_box_internal_box
                            }
                        }
                      \cus_rule_vertical:n {#1}
                    }
...
\cs_new_protected:Npn \__cus_box_frame:NNNNnnn #1#2#3#4#5#6#7 % l, b, r, t, 
  {
    \group_begin:
      \hbox_set:Nn \l__cus_box_internal_box {#7}
      \hbox:n
        {
          \__cus_kern:n { \if_int_odd:w #1 \exp_stop_f: #5 + #6 \else: 0pt \fi: }
          \box_use:N \l__cus_box_internal_box
          \__cus_kern:n { - \box_wd:N \l__cus_box_internal_box \if_int_odd:w #1 - #6 - #5 \fi: }
          \box_move_down:nn { \box_dp:N \l__cus_box_internal_box \if_int_odd:w #4 + #6 + #5 \fi: }
            {
              \vbox:n
                {
                  ...
                  \hbox:n
                    {
                      ...
                      \__cus_kern:n { \if_int_odd:w #1 + #6 \fi: \if_int_odd:w #3 + #6 \fi: + \box_wd:N \l__cus_box_internal_box }
                      \vbox:n
                        {
                          \__cus_kern:n 
                            {
