...
\cs_new_protected:Npn \__cus_bfground_rt:n #1
  {
    \hbox_set_to_wd:Nnn \l__cus_bgfg_box { \Gm@layoutwidth } { \tex_hfil:D #1 }
    \put (\Gm@layouthoffset,-\Gm@layoutvoffset) 
      { \vbox_to_zero:n { \box_use_drop:N \l__cus_bgfg_box \tex_vss:D } }
  }
...
\cs_new_protected:Npn \__cus_bfground_cm:n #1
  {
    \hbox_set:Nn \l__cus_bgfg_box {#1}
    \put ({\Gm@layouthoffset+.5\Gm@layoutwidth-.5\box_wd:N \l__cus_bgfg_box} , 
          {-\Gm@layoutvoffset-.5\Gm@layoutheight-.5\box_ht:N \l__cus_bgfg_box+.5\box_dp:N \l__cus_bgfg_box} )
      { \tex_vbox:D { \box_use_drop:N \l__cus_bgfg_box } }
  }
\cs_new:Npn \__cus_bfground_ot:n 
  {
...
\cs_new:Npn \__cus_bfground_it:n 
  {
    \legacy_if:nTF { @twoside }
      {
        \if_int_odd:w \c@page 
...
\cs_new:Npn \__cus_bfground_ob:n 
  {
    \legacy_if:nTF { @twoside }
      {
        \if_int_odd:w \c@page 
...
\cs_new:Npn \__cus_bfground_ib:n 
  {
    \legacy_if:nTF { @twoside }
      {
        \if_int_odd:w \c@page 
