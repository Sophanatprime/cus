    ...
    \keys_define:nn { cus/title/ #1 }
      {
        ...
        float-barrier .switch_set:c = title~parameter@#1@float-barrier ,
        ...
        write-tocline.bool_set:c = title~parameter@#1@write-tocline ,
        write-tocline.initial:n = true ,
...
\cs_new:Npn \title@addtocline #1
  {
    ...
    \bool_if:cT { title~parameter@ \CurrentTitleName @ write-tocline }
      {
        \addcontentsline {toc} 
...
\cs_new:Npn \title@iffloatbarrier
  { \bool_if:cTF { title~parameter@ \CurrentTitleName @float-barrier } }
