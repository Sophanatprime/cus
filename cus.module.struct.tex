...
\cs_new_protected_nopar:Npn \setuponetitle #1
  {
    \cs_if_exist:cTF {#1} { \cus_setup_title:nn {#1} }
      { 
...
\cus_set_title_key_store_code:nn { @name-preto }
  {
    \seq_put_right:Nn \l__cus_title_restore_key_seq { name-preto }
    \cs_set_eq:cc { title~tmpstore@pre #1 } { title~parameter@pre #1 }
  }
\cus_set_title_key_store_code:nn { @name-appto }
  {
...
\cus_set_title_key_restore_code:nn { @name-preto }
  { \cs_set_eq:cc { title~parameter@pre #1 } { title~tmpstore@pre #1 } }
\cus_set_title_key_restore_code:nn { @name-appto }
  { \cs_set_eq:cc { title~parameter@post #1 } { title~tmpstore@post #1 } }
...
\cus_ignore_title_key_store_restore:n { @style } 
...
\cus_ignore_title_key_store_restore:n { @number-format } 
\cus_ignore_title_key_store_restore:n { @label-format } 
\cus_ignore_title_key_store_restore:n { @tags+ } 
