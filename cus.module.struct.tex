...
\cs_new_protected:Npn \__cus_contentsline_push_def:nn #1#2
  {
    ...
    \cs_set:Npn \cus@cbl@contentsline@ {#2}
  }
\cs_new_protected:Npn \__cus_contentsline_pop_def:
  {
        ...
        \tl_if_blank:nTF {##4}
          {
            \cus_if_keyval_variable:nNnn {##3}
              ...
              {
                \__cus_title_full:onnnnn \l__cus_title_curr_keys_tl
                  {#2} {#3} {##1} {##5} {##5}
              }
              {
                \tl_if_empty:NTF \l__cus_title_curr_keys_tl
                  { \__cus_title_normal:nnnnn {#2} {#3} {##1} {##5} {##5} }
                  { \__cus_title_normal:nnnnn {#2} {#3} {##1} {##3} {##5} }
              }
          }
          { \__cus_title_full:nnnnnn {##3} {#2} {#3} {##1} {##4} {##5} }
    ...
    \keys_define:nn { cus/title/ #1 }
      {
        ...
        numbering / one  .code:n = \__cus_title_set_mode:nn {#1} { normal } ,
...
\cs_new:Npn \__cus_title_mode_case_end:nw #1#2#3 \s__str_mark #4#5 \s__str_stop
  { \exp_end: #1 #4 }
...
\NewDocumentCommand \setplaintocdepth { >{\TrimSpaces} m }
  { 
