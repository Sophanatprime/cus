    ...
    framed / lfbox .code:n = 
      {
        ...
        \cs_set_protected:Npn \cus@update@multi@width ##1
          {
            \advance##1-
        ...
        \cs_set_protected:Npn \cus@update@multi@box ##1 
          { \hbox { \exp_args:NNo \lfbox [ \cus@multicol@framed@options ] {##1} } }
        \cs_set_protected:Npn \cus@update@multi@framedgeometry { \fboxset }
      }
  }
...
\NewDocumentCommand \fparbox { O{c} O{\relax} O{s} m O{} }
  {
    ...
    \use:e 
      {
        \cus_peek_minipage:Nnnnnnw \l__cus_tmpc_box 
          { 
...
\NewDocumentCommand \fvarbox { O{c} O{\relax} O{s} m O{} }
  {
    ...
    \use:e 
      {
        \cus_peek_varwidth:Nnnnnnw \l__cus_tmpc_box 
          { 
