...
\__cus_int_let:Nw \c__cus_package_rule_unrelated_int = 0~
\__cus_int_let:Nw \c__cus_package_rule_xW_int = 1~ % imcompatible-warning
\__cus_int_let:Nw \c__cus_package_rule_xE_int = 2~ % imcompatible-error
\__cus_int_let:Nw \c__cus_package_rule_xI_int = 3~ % imcompatible-ignore
\__cus_int_let:Nw \c__cus_package_rule_voids_int = 4~
\__cus_int_let:Nw \c__cus_package_rule_require_int = 5~
\__cus_int_let:Nw \c__cus_package_rule_call_int = 6~
\__cus_int_let:Nw \c__cus_package_rule_or_int = 7~
\__cus_int_let:Nw \c__cus_package_rule_ordered_int = 8~
